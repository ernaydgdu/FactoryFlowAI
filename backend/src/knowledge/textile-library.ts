...
export const TEXTILE_KNOWLEDGE_LIBRARY: KnowledgeCard[] = [
  ...
  },
  {
    ...
    icerik:
      'Konfeksiyonda yaygın kullanılan dikiş türleri şunlardır: Düz dikiş, en temel dikiş türüdür; iki kumaş katını düz bir hatla birleştirir. Overlok, kumaş kenarını sararak saçılmayı önler; özellikle örme kumaşlarda kenar temizliği ve birleştirme için kullanılır. Reçme (zincir dikiş), elastik bir dikiştir, kumaşla birlikte esner; tişört etek ucu, kol ucu gibi bantlama işlemlerinde tercih edilir. Zigzag dikiş, esnek bir yapıya sahiptir; aplike ve yama işlemlerinde, kenar temizliğinde kullanılır. Çift iğne dikiş, birbirine paralel iki dikiş hattından oluşur; hem güçlendirme hem dekoratif amaçla kullanılır, kot ve pantolon paça ucunda yaygındır. Kör dikiş (blind stitch), dıştan görünmeyen bir dikiştir; etek ve pantolon paçası kıvırma işlemlerinde, dikişin dışarıdan belli olmaması istendiğinde kullanılır. Doğru dikiş türü seçimi, hem ürünün dayanıklılığını hem de görünümünü doğrudan etkiler.',
  },
  {
  ...
  {
    id: 'beden-kalip-buyutme-kuculme',
    baslik: 'Beden Kalıp Büyütme-Küçültme (Grading) Nedir?',
    kategori: 'temel-kavramlar',
    anahtarKelimeler: [
      'grading',
      'gradeleme',
    ...
    icerik:
      'Beden kalıp büyütme-küçültme (grading), temel bedenden (genellikle M) yola çıkarak diğer bedenlerin (S, L, XL vb.) kalıplarını sistematik ölçü farklarıyla türetme işlemidir. Her beden arasındaki fark (grade rule/grade kuralı) genellikle sabit bir artış veya azalış değeridir — örneğin göğüs çevresi her bedende 4 cm artabilir. Bu artış/azalışlar sadece toplam ölçüde değil, kalıbın belirli noktalarında (omuz, kol oyuntusu, bel, kalça vb.) dengeli biçimde dağıtılır. Doğru grading yapılmazsa farklı bedenlerdeki ürünlerin oranları bozulur — örneğin L beden bir ürün orantısız biçimde geniş veya dar çıkabilir — bu da müşteri şikayetlerine ve iade oranının artmasına yol açar. Grading işlemi genellikle modelist veya kalıpçı tarafından, kalıp serileştirme fonksiyonlarına sahip CAD (bilgisayar destekli tasarım) yazılımlarıyla yapılır; bu sayede tüm beden aralığı için tutarlı ve hızlı kalıp seti üretilebilir.',
  },
  {
    id: 'aql-kalite-standardi',
    baslik: 'AQL (Kabul Edilebilir Kalite Seviyesi) Nedir?',
    kategori: 'kalite',
    anahtarKelimeler: [
      'aql',
    ...
    icerik:
      'AQL (Acceptable Quality Level — Kabul Edilebilir Kalite Seviyesi), bir parti üründe istatistiksel örnekleme yöntemiyle kalite kontrol yapmayı sağlayan bir standarttır (ISO 2859 tabanlı). Bu yöntemde partideki tüm ürünler değil, parti büyüklüğüne göre belirlenen bir örneklem sayısı kontrol edilir; bu da zaman ve maliyetten tasarruf sağlarken istatistiksel olarak güvenilir bir kalite değerlendirmesi sunar. AQL 2.5, hazır giyimde en yaygın kullanılan seviyedir ve örneklemde %2,5\'e kadar hatalı ürün oranının kabul edilebilir olduğu anlamına gelir. Kontrol sonucunda tespit edilen hatalar iki kategoriye ayrılır: Major Defect (önemli hata), ürünün fonksiyonunu veya görünümünü ciddi biçimde etkileyen hatalardır (örn. açık dikiş, yanlış ölçü); Minor Defect (küçük hata) ise ürünün kullanımını veya satışını büyük ölçüde etkilemeyen, göz ardı edilebilir küçük kusurlardır. Örneklemdeki hata sayısı, önceden belirlenen kabul/red eşiğiyle karşılaştırılarak partinin kabul mü red mi edileceğine karar verilir. Buyer\'lar (alıcı firmalar) genellikle kendi AQL seviyelerini (1.5, 2.5, 4.0 gibi) sözleşmede veya kalite talimatında açıkça belirtir; daha düşük AQL değeri daha sıkı kalite toleransı anlamına gelir.',
  },
  {
    id: 'numune-gelistirme-asamalari',
    baslik: 'Numune Geliştirme Aşamaları',
    kategori: 'uretim-planlama',
    anahtarKelimeler: [
      'numune geliştirme',
      'numune aşamaları',
    ...
    icerik:
      'Hazır giyimde numune geliştirme, seri üretime geçmeden önce belirli sırayla ilerleyen aşamalardan oluşur: 1) Proto Numune — ilk taslak numunedir, kalıbın ve tasarımın genel doğruluğunu kontrol etmek amacıyla dikilir; genellikle gerçek üretim kumaşı kullanılmaz, benzer bir kumaşla hazırlanabilir. 2) Fit Numune — kalıbın vücuda uyumunu kontrol etmek için hazırlanır; canlı model veya manken üzerinde giydirme testi yapılır, gerekirse kalıpta düzeltmeler uygulanır. 3) PP Numune (Pre-Production Sample) — gerçek üretimde kullanılacak asıl kumaş ve aksesuarlarla dikilen, seri üretim öncesi son onay numunesidir; buyer onayı olmadan seri üretime geçilmemelidir (bkz. "PP Numune Nedir" kartı). 4) Size Set Numune — sipariş kapsamındaki tüm bedenlerin kalıp oranlarının ve ölçülerinin doğru gradelenip gradelenmediğini kontrol etmek için hazırlanır. 5) Shipment/TOP Numune (Top of Production) — üretimin başlangıcında, gerçek seri üretim hattından rastgele seçilen numunedir; gerçek üretim kalitesini temsil eder ve sevkiyat öncesi yapılan son kontrol aşamasıdır. Bu aşamaların her biri bir öncekinin onayına bağlıdır; herhangi bir aşamanın atlanması veya onaysız geçilmesi, üretim sürecinde kalite riskini ve revizyon/iade olasılığını önemli ölçüde artırır.',
  },
  {
    id: 'aksesuar-turleri',
    baslik: 'Konfeksiyonda Aksesuar (Trim) Türleri',
    kategori: 'temel-kavramlar',
    anahtarKelimeler: [
      'aksesuar türleri',
      'trim',
    ...
    icerik:
      'Konfeksiyonda yaygın kullanılan aksesuar (trim) türleri şunlardır: Fermuar — spiral, metal veya plastik diş tiplerinde üretilir; uzunluk ve renk genellikle siparişe özel belirlenir. Düğme — plastik, metal veya ahşap gibi farklı malzemelerden üretilir; çap ve delik sayısı (2 delik, 4 delik, sap düğme vb.) çeşitlilik gösterir. Etiket — dört ana türü vardır: ana etiket/marka etiketi (marka kimliğini gösterir), yıkama talimatı etiketi (bakım sembollerini içerir), fiyat etiketi/kartela (satış noktasında asılı kalan etiket) ve boyut (beden) etiketi. Elastik — bel, kol ve paça bantlarında esneklik sağlamak için kullanılır. Fitil/kordon — kapüşon büzgüsü, bel büzgüsü gibi ayarlanabilir bölgelerde kullanılır. Yapışkan bant/interlining (tela) — yaka, manşet gibi bölgelere sertlik ve form kazandırmak için kumaşın iç yüzeyine ısıyla yapıştırılır. Çıtçıt/kopça — hızlı açma-kapama gerektiren bölgelerde düğmeye alternatif olarak kullanılır. Aksesuar seçimi hem ürünün fonksiyonelliğini (dayanıklılık, kullanım kolaylığı) hem de estetiğini doğrudan etkiler; yanlış veya kalitesiz aksesuar kullanımı, üretim sonrası müşteri şikayetlerinin en sık karşılaşılan nedenlerinden biridir.',
  },
  {
    id: 'kumas-bakim-sembolleri',
    baslik: 'Kumaş Bakım/Yıkama Sembolleri',
    kategori: 'kalite',
    anahtarKelimeler: [
      'bakım sembolleri',
      'yıkama sembolleri',
    ...
    icerik:
      'Kumaş bakım/yıkama sembolleri, bir ürünün nasıl bakım göreceğini standart görsel işaretlerle anlatan uluslararası bir sistemdir (ISO 3758 standardına dayanır). Temel semboller şunlardır: Kova sembolü, yıkama işlemini gösterir; içindeki sayı, izin verilen maksimum yıkama sıcaklığını (°C) belirtir. Üçgen sembolü, ağartma işlemiyle ilgilidir; üçgenin içi boşsa ürün ağartılabilir, üçgenin üzerinde çarpı işareti varsa ürün ağartılamaz. Kare sembol, kurutma işlemini gösterir; kare içindeki nokta sayısı kurutma sıcaklık seviyesini belirtir (nokta sayısı arttıkça sıcaklık artar). Ütü sembolü, ütüleme talimatını gösterir; ütü şeklinin içindeki nokta sayısı sıcaklık seviyesini belirtir — 1 nokta düşük sıcaklık (genellikle sentetik kumaşlar için), 3 nokta yüksek sıcaklık (genellikle pamuk/keten için) anlamına gelir. Daire sembolü ise kuru temizleme talimatını gösterir. Bu semboller genellikle ürün etiketinde bulunması buyer (alıcı firma) tarafından sözleşmesel olarak zorunlu tutulan bir gerekliliktir, çünkü tüketicinin ürünü doğru bakımla kullanmasını sağlar ve yanlış bakımdan kaynaklanan şikayetleri azaltır.',
  },
  {
    id: 'utu-sicaklik-tablosu',
    baslik: 'Kumaş Tipine Göre Ütü Sıcaklık Rehberi',
    kategori: 'kalite',
    anahtarKelimeler: [
      'ütü sıcaklığı',
      'ütü sıcaklık tablosu',
      'sentetik ütü',
      'ipek ütü',
      'yün ütü',
      'pamuk ütü',
    ...
    icerik:
      'Kumaş tipine göre doğru ütü sıcaklığının seçilmesi, kumaşın hasar görmeden (erime, parlama, sertleşme) düzgün biçimde ütülenmesi için kritik önem taşır. Genel rehber şu şekildedir: Sentetik kumaşlar (polyester, naylon, akrilik) düşük sıcaklıkta (yaklaşık 110°C) ütülenmelidir; bu kumaşlar yüksek sıcaklıkta kolayca erir veya parlar, bu yüzden dikkatli olunmalıdır. İpek ve yün, orta-düşük sıcaklıkta (yaklaşık 150°C) ütülenmelidir; bu tür kumaşlarda genellikle buharlı ütü tercih edilir, çünkü buhar hem ütüleme etkinliğini artırır hem de kumaşın doğrudan yüksek sıcaklığa maruz kalmasını azaltır. Pamuk, orta-yüksek sıcaklıkta (yaklaşık 180-200°C) ütülenebilir; dayanıklı bir elyaf olduğu için daha yüksek sıcaklığa toleranslıdır. Keten, en dayanıklı kumaşlardan biridir ve yüksek sıcaklıkta (yaklaşık 200-220°C) ütülenebilir. Karışım kumaşlarda (örneğin polyester-pamuk karışımı) mutlaka karışımdaki daha düşük sıcaklık toleransına sahip elyafın sıcaklığı esas alınmalıdır; aksi hâlde kumaş üzerinde erime, parlama veya sertleşme gibi kalıcı hasarlar oluşabilir.',
  },
  {
    id: 'dikis-payi-standartlari',
    baslik: 'Dikiş Payı (Seam Allowance) Standartları',
    kategori: 'temel-kavramlar',
    anahtarKelimeler: [
      'dikiş payı',
      'seam allowance',
      'dikiş payı standartları',
      'kesim hattı',
      'yan dikiş payı',
      'yaka payı',
      'kol oyuntusu payı',
    ...
    icerik:
      'Dikiş payı (seam allowance), kalıbın kesim hattı ile asıl dikiş hattı arasındaki mesafedir; parçaların birbirine dikilerek birleştirilebilmesi için kesim ölçüsüne eklenen ek pay gereklidir. Standart dikiş payı genellikle 1-1,5 cm\'dir, ancak vücut bölgesine göre değişir: Yan dikişler gibi düz hatlarda genellikle 1-1,5 cm dikiş payı kullanılır. Yaka ve kol oyuntusu gibi eğrisel (kavisli) bölgelerde daha dar bir pay (0,6-1 cm) tercih edilir; çünkü eğrisel hatlarda fazla dikiş payı, dikildikten sonra kumaşta dalgalanmaya veya buruşmaya yol açar. Etek ve paça kıvırma (büzme/reçme) yapılacak bölgelerde ise daha geniş bir pay (2-4 cm) bırakılır, çünkü kumaş kıvrılarak dikileceği için ekstra malzemeye ihtiyaç vardır. Dikiş payının kalıpta doğru işaretlenmemesi veya kesim/dikim aşamasında yanlış uygulanması, üretimde sık karşılaşılan ve ürün ölçülerinde hataya yol açan yaygın bir sorundur; bu nedenle şablon hazırlama aşamasında dikiş payı işaretlerinin (çentik, delik vb.) doğru ve net biçimde belirtilmesi önemlidir.',
  },
  {
    id: 'kalite-defect-terimleri',
    baslik: 'Konfeksiyonda Kalite Hata (Defect) Terimleri',
    kategori: 'kalite',
    anahtarKelimeler: [
      'defect terimleri',
      'kalite hata terimleri',
      'shading',
      'ton farkı',
      'skew',
      'çarpıklık',
    ...
    icerik:
      'Konfeksiyonda kalite kontrol sürecinde sık karşılaşılan standart hata (defect) terimleri şunlardır: Shading (Ton Farkı) — aynı üründe farklı parçalar arasında görülen renk sapmasıdır, genellikle farklı kumaş partilerinin (lot) bir arada kullanılmasından kaynaklanır. Skew (Çarpıklık) — kumaş deseninin veya dikiş hattının eğri/çarpık olmasıdır, genellikle kesim veya dikim sırasında kumaşın düzgün hizalanmamasından oluşur. Puckering (Büzülme) — dikiş hattı boyunca istenmeyen büzülme veya dalgalanmadır, çoğunlukla yanlış iplik gerginliği veya uygunsuz iğne/dikiş ayarından kaynaklanır. Misalignment (Hizasızlık) — cep, yaka gibi simetrik olması gereken parçaların birbirine göre hizasız veya asimetrik konumlanmasıdır. Broken Stitch (Kopuk Dikiş) — dikiş ipliğinin kopmasıyla oluşan hatadır. Skip Stitch (Atlamış Dikiş) — dikiş makinesinin bazı noktalarda dikiş atlaması sonucu oluşan boşluklu dikiştir. Open Seam (Açık Dikiş) — dikiş hattının sökülmesi veya açılmasıdır, genellikle major defect (önemli hata) olarak sınıflandırılır. Stain (Leke) — ürün üzerinde görülen istenmeyen renk lekesidir. Bu terimler kalite kontrol raporlarında standart olarak kullanılır; kalite kontrolcünün hatayı doğru terimle ve doğru önem derecesiyle (major/minor) sınıflandırması, AQL değerlendirmesinde ve kabul/red kararında kritik önem taşır.',
  },
  {
    id: 'incoterms-genel',
    baslik: 'INCOTERMS (Uluslararası Ticaret Terimleri) Nedir?',
    kategori: 'ihracat-lojistik',
    anahtarKelimeler: [
      'incoterms',
      ...
      'exw',
      'ddp',
      'ihracat teslim şekli',
      'teslim şekli',
      'icc',
    ],
    icerik:
      'INCOTERMS (International Commercial Terms), satıcı ve alıcı arasında malın taşınması, sigortası ve gümrük sorumluluklarının kimde olduğunu tanımlayan uluslararası standart terimlerdir; Milletlerarası Ticaret Odası (ICC) tarafından yayınlanır ve düzenli aralıklarla güncellenir. Tekstil ihracatında en sık kullanılan terimler şunlardır: FOB (Free On Board) — mal gemiye veya taşıyıcı araca yüklenene kadar tüm masraf ve risk satıcıya aittir, yükleme sonrası sorumluluk alıcıya geçer; deniz/iç su taşımacılığında kullanılır. CIF (Cost Insurance Freight) — satıcı, navlun (taşıma) ve sigorta masraflarını da üstlenerek malı varış limanına kadar taşır, ancak risk yine yükleme anında alıcıya geçer. EXW (Ex Works) — satıcının sorumluluğu malı kendi fabrikasında/deposunda alıcının tasarrufuna hazır bulundurmakla sınırlıdır; yükleme, taşıma, sigorta ve gümrük dahil tüm sorumluluk ve maliyet alıcıya aittir; satıcı için en az sorumluluk gerektiren terimdir. DDP (Delivered Duty Paid) — satıcı, gümrük vergileri dahil olmak üzere tüm masraf ve riskleri üstlenip malı doğrudan alıcının belirttiği adrese kadar teslim eder; satıcı için en yüksek sorumluluk gerektiren terimdir. Hangi INCOTERM\'in kullanılacağı, fiyatlandırmayı ve maliyet hesabını doğrudan etkiler; bir teklif veya sipariş onayı hazırlanırken kullanılan INCOTERM\'in doğru belirtilmesi, fiyata nelerin dahil olduğu konusunda anlaşmazlık yaşanmaması açısından kritik önem taşır.',
  },
  {
    id: 'gumruk-ihracat-evraklari',
    baslik: 'Tekstil İhracatında Temel Gümrük ve İhracat Evrakları',
    kategori: 'ihracat-lojistik',
    anahtarKelimeler: [
      'gümrük evrakları',
      'ihracat evrakları',
    ...
    icerik:
      'Tekstil ihracatında sevkiyat öncesi hazırlanması gereken temel gümrük/ihracat evrakları şunlardır: Ticari Fatura (Commercial Invoice) — malın değerini, alıcı/satıcı bilgilerini ve kullanılan INCOTERM\'i gösteren, gümrük işlemlerinin temelini oluşturan belgedir. Çeki Listesi/Packing List — sevkiyatın koli/palet bazında miktar, içerik ve ağırlık detayını gösterir; gümrük kontrolünde ve depoda malın fiziksel doğrulanmasında kullanılır. Menşe Şahadetnamesi (Certificate of Origin) — malın hangi ülkede üretildiğini belgeler; alıcı ülkenin gümrük vergisi avantajlarından (tercihli tarife) yararlanabilmesi için genellikle zorunludur. Gümrük Beyannamesi (GB) — ihracatın resmî kaydını oluşturan, gümrük idaresine sunulan beyan belgesidir. Konşimento/Bill of Lading (B/L) — deniz taşımacılığında malın taşıyıcı tarafından teslim alındığını gösteren, aynı zamanda mülkiyet belgesi niteliği taşıyan evraktır; taşıyıcı (armatör/nakliyeci) tarafından düzenlenir. ATR Belgesi — Türkiye-AB Gümrük Birliği kapsamında, AB ülkeleriyle yapılan ticarette gümrük vergisi muafiyeti sağlayan dolaşım belgesidir. Her sevkiyat öncesinde bu evrakların eksiksiz ve doğru şekilde hazırlanması, malın gümrükte beklememesi ve teslim sürecinin aksamaması açısından kritik önem taşır; evraklardaki bir eksiklik veya tutarsızlık, sevkiyatın günler hatta haftalarca gümrükte bekletilmesine yol açabilir.',
  },
  {
    id: 'baski-teknikleri',
    baslik: 'Tekstilde Yaygın Baskı Teknikleri',
    kategori: 'baski-nakis',
    anahtarKelimeler: [
      'baskı teknikleri',
      'serigrafi',
      'screen printing',
    ...
    icerik:
      'Tekstilde yaygın kullanılan baskı teknikleri şunlardır: Serigrafi/Screen Printing — şablon (kalıp) üzerinden mürekkebin kumaşa geçirilmesi esasına dayanır; yüksek adetlerde ekonomiktir ve canlı, opak renkler elde edilebilir, ancak her renk için ayrı şablon gerektiğinden çok renkli tasarımlarda maliyet artar. Dijital Baskı/DTG (Direct to Garment) — bilgisayardan doğrudan kumaşa baskı yapılır; şablon gerektirmediği için düşük adetlerde ve karmaşık/çok renkli desenlerde idealdir, adet başı maliyeti adet arttıkça düşmez (sabittir). Transfer Baskı — tasarım önce özel bir transfer kağıdına basılır, ardından ısı ve basınçla kumaşa aktarılır; küçük adetlerde ve numune üretiminde pratik bir yöntemdir. Sublimasyon — boyanın ısı altında gaz hâline geçip polyester elyafının içine işlemesi esasına dayanır; özellikle spor giyimde canlı ve kalıcı (solmaya dayanıklı) desenler için tercih edilir, ancak yalnızca polyester veya yüksek polyester oranlı sentetik kumaşlarda etkilidir, pamukta uygulanamaz. Batik/El Baskısı — geleneksel, el işçiliğine dayalı bir tekniktir; düşük adetli özel/butik üretimlerde ve el yapımı görünüm istenen tasarımlarda kullanılır. Baskı tekniği seçimi; sipariş adedi, bütçe, kumaş tipi (elyaf içeriği) ve tasarımın renk/detay karmaşıklığına göre belirlenir; yanlış teknik seçimi hem maliyeti gereksiz yere artırabilir hem de baskı kalitesinde (solma, çatlama, yapışmama) sorunlara yol açabilir.',
  },
  {
    id: 'nakis-teknikleri',
    baslik: 'Tekstilde Nakış (Embroidery) Türleri',
    kategori: 'baski-nakis',
    anahtarKelimeler: [
      'nakış teknikleri',
      'embroidery',
    ...
    icerik:
      'Tekstilde nakış (embroidery) türleri şunlardır: Makine Nakışı — bilgisayar kontrollü nakış makineleriyle yapılır; hızlı, tutarlı ve tekrarlanabilir sonuç verir, logo/marka işlemede standart ve en yaygın yöntemdir. El Nakışı — geleneksel, tamamen el işçiliğine dayalı bir tekniktir; özel/lüks ürünlerde ve butik üretimlerde tercih edilir, işçilik maliyeti yüksektir. Aplike — farklı bir kumaş parçasının, ana kumaşın üzerine kesilip dikilerek desene dönüştürülmesidir; genellikle nakışla birlikte kullanılarak dokulu ve katmanlı bir görünüm elde edilir. 3D/Kabartma Nakış — dolgu ipliği veya köpük altlık kullanılarak desenin kabartılıp üç boyutlu bir görünüm kazandırılmasıdır; özellikle şapka ve logo işlemede tercih edilir, düz nakışa göre daha belirgin ve dokulu bir etki yaratır. Şönil Nakış — kalın, kadifemsi (chenille) iplikle yapılan, hacimli ve dokulu bir görünüm veren nakış türüdür; genellikle varsity/okul ceketlerinde ve amblemlerde kullanılır. Nakış tekniği seçimi; ürünün kullanım alanı, istenen görsel etki (düz/kabartmalı/dokulu), bütçe ve üretim adedine göre belirlenir. Nakış siparişlerinde iğne/dikiş sayısı (stitch count) maliyeti doğrudan etkiler: yoğun ve karmaşık tasarımlar daha fazla dikiş gerektirdiğinden, adet başına maliyeti daha yüksektir.',
  },
  {
    id: 'gots-sertifikasi',
    baslik: 'GOTS (Global Organic Textile Standard) Sertifikası Nedir?',
    kategori: 'sertifikasyon',
    anahtarKelimeler: [
      'gots',
      'global organic textile standard',
      'organik tekstil',
      'organik pamuk sertifikası',
      'sertifika',
      'sertifikasyon',
      'nedir',
      'buyer talebi',
    ...
    icerik:
      'GOTS (Global Organic Textile Standard), organik elyaftan (başta organik pamuk olmak üzere) üretilen tekstil ürünleri için dünya çapında geçerli en kapsamlı sertifikasyon standardıdır. GOTS, tek bir işlemi değil, hammaddeden nihai ürüne kadar tüm üretim zincirini kapsar: elyaf üretimi/hasadı, iplik ve kumaş işleme (eğirme, dokuma/örme, boyama, terbiye), konfeksiyon üretimi, paketleme, etiketleme, ihracat ve dağıtım aşamalarının tamamı denetime tabidir. Sertifikasyon kapsamı yalnızca hammaddenin organik olmasıyla sınırlı değildir; kullanılan kimyasalların (boya, yardımcı kimyasal) çevreye ve insan sağlığına zararsız olması, atık su yönetimi gibi çevresel kriterler ile çalışan hakları, adil ücret, güvenli çalışma koşulları ve çocuk işçi yasağı gibi sosyal sorumluluk kriterleri de GOTS kapsamında değerlendirilir. Bir ürünün "GOTS sertifikalı" sayılabilmesi için tedarik zincirindeki her işletmenin (kumaşçı, boyahane, konfeksiyoncu vb.) ayrı ayrı sertifikalandırılmış olması ve yıllık denetimlerden geçmesi gerekir. Özellikle Avrupa pazarına satış yapan buyer\'lar sıklıkla GOTS sertifikalı üretim talep eder; bu sertifika olmadan bazı pazarlara veya bazı büyük perakende zincirlerine mal satmak mümkün olmaz, bu nedenle sipariş alım aşamasında GOTS şartı olup olmadığının netleştirilmesi önemlidir.',
  },
  {
    id: 'oeko-tex-sertifikasi',
    baslik: 'OEKO-TEX Standard 100 Sertifikası Nedir?',
    kategori: 'sertifikasyon',
    anahtarKelimeler: [
      'oeko-tex',
      'oeko tex',
    ...
    icerik:
      'OEKO-TEX Standard 100, tekstil ürünlerinin insan sağlığına zararlı kimyasal madde içermediğini test eden ve belgeleyen, bağımsız bir kuruluş (OEKO-TEX Association) tarafından yürütülen uluslararası bir sertifikasyon sistemidir. Ürünün kullanım amacına ve vücuda temas derecesine göre 4 ürün sınıfına ayrılır: Sınıf 1, bebek ve küçük çocuk ürünleri için en sıkı limitleri içerir; Sınıf 2, cilt ile doğrudan temas eden ürünler (iç çamaşırı, gömlek vb.); Sınıf 3, cilt ile doğrudan temas etmeyen ürünler (astar, dış giyim vb.); Sınıf 4 ise döşemelik ve dekoratif tekstil ürünleri için en gevşek limitleri içerir. Test kapsamında azo boyar madde, formaldehit, ağır metal, pestisit kalıntısı, ftalat gibi insan sağlığına zararlı olabilecek maddelerin ürün üzerinde belirlenen limitlerin altında kalıp kalmadığı laboratuvar testleriyle doğrulanır. OEKO-TEX ile GOTS arasındaki temel fark şudur: OEKO-TEX yalnızca nihai ürünü test eder ve ürünün zararlı kimyasal içermediğini garanti eder — hammaddenin organik olup olmadığıyla veya üretim sürecindeki sosyal/çevresel koşullarla ilgilenmez. GOTS ise hem hammaddenin organik kökenini hem de tüm tedarik zincirindeki çevresel ve sosyal sorumluluk kriterlerini kapsar. Bu nedenle bir ürün OEKO-TEX sertifikalı olabilir ama organik olmayabilir; buyer talebine göre hangi sertifikanın (veya ikisinin birden) gerekli olduğu netleştirilmelidir.',
  },
  {
    id: 'grs-sertifikasi',
    baslik: 'GRS (Global Recycled Standard) Sertifikası Nedir?',
    kategori: 'sertifikasyon',
    anahtarKelimeler: [
      'grs',
    ...
    icerik:
      'GRS (Global Recycled Standard), geri dönüştürülmüş elyaftan (recycled polyester/r-PET, geri dönüştürülmüş pamuk vb.) üretilen tekstil ürünleri için geçerli uluslararası bir sertifikasyon standardıdır ve Textile Exchange adlı kuruluş tarafından yönetilir. Bir ürünün GRS sertifikalı sayılabilmesi için içeriğinde en az %20 geri dönüştürülmüş malzeme bulunması gerekir; "GRS sertifikalı" etiketinin ürün üzerinde kullanılabilmesi için ise genellikle %50 ve üzeri geri dönüştürülmüş içerik oranı aranır. GRS, yalnızca malzemenin geri dönüştürülmüş olduğunu değil, bu malzemenin kaynağından nihai ürüne kadar tüm tedarik zinciri boyunca izlenebilirliğini (chain of custody) de doğrular; yani her aşamadaki işletmenin (iplikçi, dokumacı/örmeci, boyahane, konfeksiyoncu) ayrı ayrı sertifikalandırılması ve malzeme akışının kayıt altında tutulması gerekir. GRS ayrıca kimyasal kullanım kısıtlamaları ile sosyal sorumluluk (çalışan hakları, güvenli çalışma koşulları) ve temel çevresel yönetim kriterlerini de kapsar; bu yönüyle GOTS\'a benzer bir denetim yapısına sahiptir, ancak GOTS\'un odağı organik hammadde iken GRS\'in odağı geri dönüştürülmüş içeriktir. GRS, özellikle sürdürülebilirlik odaklı spor giyim ve outdoor markalarının r-PET kumaş taleplerinde sıkça aranan bir sertifikadır; buyer bu sertifikayı talep ettiğinde, kullanılacak geri dönüştürülmüş kumaş/iplik tedarikçisinin geçerli bir GRS sertifikasına ve transaction certificate (TC) belgesine sahip olması gerekir.',
  },
  {
    id: 'kumas-test-yontemleri',
    baslik: 'Kumaş Test Yöntemleri',
    kategori: 'kumas-bilgisi',
    anahtarKelimeler: [
      'kumaş test',
      'test yöntemleri',
