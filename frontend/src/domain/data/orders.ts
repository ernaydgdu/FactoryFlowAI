...
export const SALES_ORDERS: SalesOrder[] = Array.from({ length: 45 }, (_, i) =>
  createOrder(i),
)

/** Demo: SIP-2026-0100 — 3 atölyeye bölünmüş sipariş */
SALES_ORDERS[0] = applySplitToOrder(SALES_ORDERS[0])
...
export const LIST_ORDERS = SALES_ORDERS.map(toListOrder)
